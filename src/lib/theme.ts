...
/** Colour (dark) chips — vibrant gradients on deep navy backgrounds */
const COLOUR_CHIPS: Record<ChipVariant, ChipToken> = {
  route:    { bg:"linear-gradient(135deg,#0F2942,#1E40AF)", color:"#93C5FD", border:"transparent", shadow:"0 4px 14px rgba(15,41,66,0.5)" },
  period:   { bg:"linear-gradient(135deg,#1A1A2E,#16213E)", color:"#94A3B8", border:"transparent", shadow:"0 4px 14px rgba(26,26,46,0.5)" },
  tod:      { bg:"linear-gradient(135deg,#78350F,#D97706)", color:"#FCD34D", border:"transparent", shadow:"0 4px 14px rgba(120,53,15,0.5)" },
  worsened: { bg:"linear-gradient(135deg,#7F1D1D,#DC2626)", color:"#FCA5A5", border:"transparent", shadow:"0 4px 14px rgba(127,29,29,0.5)" },
  improved: { bg:"linear-gradient(135deg,#052E16,#059669)", color:"#86EFAC", border:"transparent", shadow:"0 4px 14px rgba(5,46,22,0.5)" },
  city:     { bg:"linear-gradient(135deg,#1E1B4B,#4338CA)", color:"#C7D2FE", border:"transparent", shadow:"0 2px 8px rgba(30,27,75,0.5)" },
};
...
export const THEMES: Record<ThemeKey, AppTheme> = {
  ...
  colour: {
    ...
    paneBg: "#1E2535",
    paneBorder: "#3A4A5C",
    titleStyle: { display:"inline-block", background:"linear-gradient(90deg,#22D3EE,#F472B6)", backgroundClip:"text", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", color:"transparent" },
    chips: COLOUR_CHIPS,
    ...
    kpiCardBgs: [
      ...
      "linear-gradient(135deg,#2D1B0E 60%,#78350F)",
      "linear-gradient(135deg,#141A24 60%,#334155)",
    ],
    ...
    speedGood: "#34D399",
    speedBad:  "#F97316",
    baselineLabel: "#F472B6",
    recentLabel:   "#22D3EE",
    emptyCalCircle: "rgba(34,211,238,0.12)",
  },
